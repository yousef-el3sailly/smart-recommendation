...
const Index = () => {
  ...
  return (
    <UserLayout>
      <SeoHead />
      <section className="border-b bg-gradient-to-br from-primary/5 to-primary/10 py-10 sm:py-16 md:py-24">
        <div className="container px-4 sm:px-6 text-center space-y-4 sm:space-y-6">
          <h1 className="text-2xl sm:text-4xl md:text-5xl font-bold tracking-tight break-words">
            {t('home.heroTitle')}
          </h1>
