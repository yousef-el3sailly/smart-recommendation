    ...
    <SidebarProvider>
      <div className="min-h-screen flex w-full">
        ...
        <div className="flex-1 flex flex-col">
          <header className="h-14 flex items-center border-b px-3 sm:px-4 gap-1 sm:gap-2">
            <SidebarTrigger className="me-1 sm:me-2 shrink-0" />
            <h1 className="font-semibold flex-1 text-sm sm:text-base truncate">{t('nav.adminDashboard')}</h1>
            <LanguageSwitcher />
          </header>
